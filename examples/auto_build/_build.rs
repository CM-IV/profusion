use profusion::{CodegenSettings, Error};

// This script will generate a new profusion file every time your schema or queries change.
...
fn main() -> Result<(), Error> {
    ...
    let destination = "src/profusion.rs";
