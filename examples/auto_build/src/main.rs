...
// Take a look at the generated `profusion.rs` file if you want to
// see what it looks like under the hood.
use profusion::queries::module_1::example_query;

// Since we generated the profusion file inside our project, you can simply
...
// and observe how your profusion modules are regenerated!
#[tokio::main]
async fn main() {
    // Connection pool configuration
    // This has nothing to do with profusion, please look at
