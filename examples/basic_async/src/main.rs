...
use profusion_async::Params;

#[tokio::main]
pub async fn main() {
    // You can learn which database connection types are compatible with profusion in the book
    // https://profusion-rs.netlify.app/book/using_queries/db_connections.html
    ...
    // Queries also accept transactions. Let's see how that works.
    {
        ...
        // "string-like" types like `String`. See https://profusion-rs.netlify.app/book/using_queries/ergonomic_parameters.html
        // for more details.
        insert_book()
    ...
    // !    (see https://profusion-rs.netlify.app/book/writing_queries/type_annotations.html for
    ...
    // They will be automatically generated by profusion.
    ...
    // profusion also supports PostgreSQL arrays, which you
